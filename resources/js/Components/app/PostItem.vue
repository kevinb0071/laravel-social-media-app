    ...
    <div class="bg-white border rounded p-4 shadow mb-4">
        <div class="flex items-center gap-2 mb-3">
            <a href="javascript:void(0)">
                <img
                    ...
                    class="w-[48px] rounded-full border-2 transition-all hover:border-blue-500"
                />
            </a>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-3">
            <template v-for="attachment of post.attachments">
                ...
                >
                    <button
                        class="opacity-0 group-hover:opacity-100 transition-all text-gray-100 w-8 h-8 flex items-center justify-center bg-gray-700 rounded absolute right-2 top-2 cursor-pointer hover:bg-gray-800"
                    >
                        <svg
